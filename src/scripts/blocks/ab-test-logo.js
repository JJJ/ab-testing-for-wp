...
function ABTestLogo() {
  return (
    <svg
      ...
      width="496.3px"
      height="426px"
      viewBox="0 0 496.3 426"
    >
      <path
        d="M343.2,314.4c-5.8-4.4-13.5-6.6-23-6.6h-48v55h47.1c4.3,0,8.4-0.4,12.3-1.3c3.9-0.8,7.4-2.2,10.4-4.2c3-2,5.4-4.6,7.2-8
        c1.8-3.4,2.7-7.7,2.7-12.9C351.9,326.1,349,318.8,343.2,314.4z"
      />
      <path
        d="M336.2,272.2c5.1-3.7,7.6-9.8,7.6-18.2c0-4.7-0.8-8.5-2.5-11.5c-1.7-3-3.9-5.3-6.7-7c-2.8-1.7-6-2.8-9.7-3.5
      ...
      <path
        d="M477.4,322L327.1,115.2V76h4.1c11.3,0,20.4-9.2,20.4-20.4V20.4c0-11.3-9.2-20.4-20.4-20.4H165.1
